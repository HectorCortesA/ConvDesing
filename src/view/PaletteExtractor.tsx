    ...
    <div className="w-full  mx-auto p-4 md:p-8">
      ...
      <AnimatePresence mode="wait">
        {step === "upload" && (
          ...
          >
            <div className="absolute top-0 left-0 w-64 h-64 bg-emerald-500/70 rounded-full blur-3xl pointer-events-none group-hover:bg-emerald-500/20 transition-all"></div>
            <div className="absolute bottom-0 right-0 w-64 h-64 bg-blue-500/70 rounded-full blur-3xl pointer-events-none group-hover:bg-teal-500/20 transition-all"></div>
          ...
          >
            ...
            <div className=" backdrop-blur-lg bg-white/8 rounded-3xl p-6 shadow-2xl flex flex-col md:flex-row gap-8">
              ...
              <div className="w-full md:w-1/2 flex flex-col gap-4">
                <div
                  className={`h-[300px] md:h-[450px] rounded-2xl overflow-hidden  backdrop-blur-lg bg-white/8  flex items-center justify-center relative transition-all ${isPicking ? "ring-2 ring-emerald-500 shadow-[0_0_20px_rgba(16,185,129,0.2)]" : ""}`}
                >
